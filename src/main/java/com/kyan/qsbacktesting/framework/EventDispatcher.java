...
public class EventDispatcher<E extends Event> {
    ...
    private Map<Class<E>, List<EventHandler<E>>> _handlers;

    public EventDispatcher() {
        _handlers = new HashMap<>();
    }

    public void registerEventHandler(Class<E> eventType, EventHandler<E> handler) {
    ...
    public boolean unregisterEventHandler(Class<E> eventType, EventHandler<E> handler) {
    ...
    public void dispatch(E event) {
        List<EventHandler<E>> handlerList = _handlers.get(event.getClass());
