...
import com.kyan.qsbacktester.model.OrderType;
import lombok.Data;
...
public class OrderEvent extends AbstractEvent {
    ...
    private LocalDateTime datetime;          // the timestamp at which the order is committed

    public OrderEvent(String symbol, OrderType orderType, Direction direction, Long quantity, LocalDateTime datetime) {
